...
interface AppLabelsDocumentData {
	...
	/**
	 * Contact Page field in *App Labels*
	 *
	 * - **Field Type**: Content Relationship
	 * - **Placeholder**: *None*
	 * - **API ID Path**: app_labels.contact_page
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/content-relationship
	 */
	contact_page: prismic.ContentRelationshipField<"contact_page">;
	
	/**
	 * Feedback Page field in *App Labels*
	 *
	 * - **Field Type**: Content Relationship
	 * - **Placeholder**: *None*
	 * - **API ID Path**: app_labels.feedback_page
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/content-relationship
	 */
	feedback_page: prismic.ContentRelationshipField<"feedback_page">;
}
...
interface ContactPageDocumentData {
	...
	/**
	 * Card Title field in *Contact Page*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: contact_page.cardTitle
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/text
	 */
	...
	/**
	 * Card Description field in *Contact Page*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: contact_page.cardDescription
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/text
	 */
	...
	/**
	 * Name Label field in *Contact Page*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: contact_page.nameLabel
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/text
	 */
	...
	/**
	 * Email Label field in *Contact Page*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: contact_page.emailLabel
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/text
	 */
	...
	/**
	 * Message Label field in *Contact Page*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: contact_page.messageLabel
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/text
	 */
	...
	/**
	 * Submit field in *Contact Page*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: contact_page.submit
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/text
	 */
	...
	/**
	 * Success Message field in *Contact Page*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: contact_page.successMessage
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/text
	 */
...
/**
 * Content for Feedback Page documents
 */
interface FeedbackPageDocumentData {
	/**
	 * Title field in *Feedback Page*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: feedback_page.title
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/text
	 */
	title: prismic.KeyTextField;
	...
	/**
	 * Description field in *Feedback Page*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: feedback_page.description
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/text
	 */
	description: prismic.KeyTextField;
	...
	/**
	 * Card Title field in *Feedback Page*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: feedback_page.cardTitle
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/text
	 */
	cardTitle: prismic.KeyTextField;
	...
	/**
	 * Card Description field in *Feedback Page*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: feedback_page.cardDescription
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/text
	 */
	cardDescription: prismic.KeyTextField;
	...
	/**
	 * Email Label field in *Feedback Page*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: feedback_page.emailLabel
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/text
	 */
	emailLabel: prismic.KeyTextField;
	...
	/**
	 * Rating Label field in *Feedback Page*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: feedback_page.ratingLabel
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/text
	 */
	ratingLabel: prismic.KeyTextField;
	
	/**
	 * Comments Label field in *Feedback Page*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: feedback_page.commentsLabel
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/text
	 */
	commentsLabel: prismic.KeyTextField;
	
	/**
	 * Submit field in *Feedback Page*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: feedback_page.submit
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/text
	 */
	submit: prismic.KeyTextField;
	...
	/**
	 * Success Message field in *Feedback Page*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: feedback_page.successMessage
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/text
	 */
	successMessage: prismic.KeyTextField;
...
/**
 * Feedback Page document from Prismic
 *
 * - **API ID**: `feedback_page`
 * - **Repeatable**: `false`
 * - **Documentation**: https://prismic.io/docs/content-modeling
 *
 * @typeParam Lang - Language API ID of the document.
 */
export type FeedbackPageDocument<Lang extends string = string> = prismic.PrismicDocumentWithoutUID<Simplify<FeedbackPageDocumentData>, "feedback_page", Lang>;
...
export interface AccordionSliceDefaultPrimary {
	/**
	 * Hide numbers field in *Accordion → Default → Primary*
	 *
	 * - **Field Type**: Boolean
	 * - **Placeholder**: *None*
	 * - **Default Value**: false
	 * - **API ID Path**: accordion.default.primary.hide_number
	 * - **Documentation**: https://prismic.io/docs/fields/boolean
	 */
	hide_number: prismic.BooleanField;
}
 ...
 *
 * - **API ID**: `accordion`
 * - **Description**: Individually collapsible sections (numbered by default) with optional cards, download buttons and links
 * - **Documentation**: https://prismic.io/docs/slices
 */
...
declare module "@prismicio/client" {
	...
	namespace Content {
		export type {
			...
			FeedbackPageDocument,
			FeedbackPageDocumentData,
			FooterDocument,
			FooterDocumentData,
			HeaderDocument,
			HeaderDocumentData,
