...
// in a browser, Edge-runtime, or plain Node file. Import the browser-safe
// generator via its direct subpath instead: `otel/trace-context`. For a
// plain Node consumer's logger/correlation needs, see `otel/logging`.
